const strings = {
  website: "https://af.pattern.monster",
  title: "Pattern Monster",
  description:
    "Um gerador de padrões simples para criar padrões SVG repetíveis.",
  description2: "Acelere seu site sem perder qualidade de imagem.",
  description3: 
    "Perfeito para design de planos e fundo de sites, roupas, marcas, pacotes, entre outros.",
  keywords:
    "padrões SVG, padrões, planos de fundo SVG, plano de fundo vetorizado, gerador de padrões, criador de padrões",
  pages: [
    {
      page: "index",
